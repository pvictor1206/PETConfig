...
import cadastrar_pet #arquivo que importa as funcoes para cadastrar animais
import consultar #arquivo que importa as funcoes para consultar animais ainda nao adotados
